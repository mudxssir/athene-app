        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="space-y-2">
              <div className="h-10 w-48 bg-muted shimmer rounded-lg" />
              <div className="h-5 w-96 bg-muted shimmer rounded-lg" />
            </div>
            <div className="h-12 w-36 bg-muted shimmer rounded-lg" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mt-8">
            {[1, 2, 3].map((i) => (
              <div key={i} className="h-64 rounded-xl border border-border bg-accent/5 shimmer" />
            ))}
          </div>
        </div>
      }>
